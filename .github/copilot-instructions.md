...
- For long arithmetic or string-concatenation expressions that exceed LongExpressionLineBreakThreshold, break lines consistently after operators (including +, -, *, /); test fixture expectations in FullSuiteSynthetic.sql are authoritative. Prefer small, narrowly-scoped C# unit tests (in SqlCanonicalizationServiceTests.cs) over large real-world .sql fixture files for new formatting scenarios.
